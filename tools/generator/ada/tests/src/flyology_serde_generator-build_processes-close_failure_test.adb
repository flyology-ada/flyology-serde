...
procedure Flyology_Serde_Generator.Build_Processes.Close_Failure_Test is
...
begin
   ...
   Require (Initialized, "close-failure budget did not initialize");
   ...
   Require (Build_State = Build_Succeeded, "close-failure command did not build");

   Test_Hooks.Arm_Close_Failure;
   ...
   Require
     (Status = Run_Cleanup_Failed
      ...
      "close ownership damage did not fail, poison, and suppress publication");
end Flyology_Serde_Generator.Build_Processes.Close_Failure_Test;
